...
// Contrôle d'accès pour éviter les demandes de connection lorsque l'utilisateur c'est trompé plus de 5 fois lors des 10 dernières minutes pour se connecter
$ip = Std::getIp();
